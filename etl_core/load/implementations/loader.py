...
class ClickHouseLoader:
    ...
    - Protocolo nativo (puerto 9000)
    - Streaming Arrow
    - Batch sizing automático
    - Carga de datasets por nombre
    """
    ...
    def __init__(self, **params):
        ...
        self.mem_thresholds = [128, 512, 1024]  # Bajo, Medio, Alto
    ...
    def load(self, table_name: str, df: pl.DataFrame):
        ...
        try:
            self.client.insert_arrow(
                ...
                settings={"insert_block_size": batch_size},
            )
        except Exception as e:
    ...
    def load_dataset(self, dataset_name: str, df: pl.DataFrame):
        ...
        table_name = DATASET_CONFIG[dataset_name]["table_name"]
        self.load(table_name, df)
