...
import polars as pl
from transform.implementation.cycle.transformer import CycleTransformer
...
def run_cycle_etl_pipeline():
    ...
    try:
        ...
        mandatory_columns = transformer.mandatory_columns  # <-- Dinámico desde el esquema
        ...
        sample_columns = [
            'ShiftDate', 'Equipment', 'G_Latitude', 
            'G_Longitude', 'D_Latitude', 'D_Longitude'
        ]
